...
const RegisterPage = () => {
    const [formData, setFormData] = useState({
        fullName: '', email: '', password: '', aadhaarNumber: '', role: 'citizen', phoneNumber: '',
        kioskId: '', department: '', designation: '',
    });
        ...
        <div className="w-full max-w-4xl mx-auto flex rounded-xl shadow-2xl overflow-hidden bg-slate-900/50 border border-slate-700 backdrop-blur-lg">
            ...
            <div className="hidden md:block md:w-1/2">
                <img 
                    ...
                    alt="Community members looking empowered" 
            ...
            <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    {/* Your form inputs remain the same here */}
                    ...
                    {formData.role === 'paralegal' && (<input name="phoneNumber" placeholder="Phone Number" onChange={handleChange} required className="input-style" />)}
                    {formData.role === 'employee' && (
                        <>
                            <input name="kioskId" placeholder="Kiosk ID" onChange={handleChange} required className="input-style" />
                            <input name="department" placeholder="Department" onChange={handleChange} required className="input-style" />
                            <input name="designation" placeholder="Designation" onChange={handleChange} required className="input-style" />
                        </>
                    )}
